...
const dict = {
  en: {
    ...
    callCenterNeedCreds: "Enter your phone and password to open Call Center.",
    callCenterFailed: "Could not open Call Center",
    editName: "Edit name",
  ...
  ru: {
    ...
    callCenterNeedCreds: "Чтобы открыть Call Center, введите телефон и пароль.",
    callCenterFailed: "Не удалось открыть Call Center",
